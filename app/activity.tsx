...
const styles = StyleSheet.create({
  ...
  unreadEvent: { backgroundColor: colors.accentSoft, borderColor: '#FFB9A7' },
  ...
  time: { color: colors.primary, fontSize: 12, fontWeight: '800', marginTop: 2, textTransform: 'uppercase' },
  ...
  markAll: { color: colors.primary, fontSize: 14, fontWeight: '900', paddingVertical: spacing.sm },
