...
const styles = StyleSheet.create({
  ...
  preview: { color: colors.textSubtle, fontSize: 11.5, lineHeight: 17 },
  time: { color: colors.primary, fontSize: 9.5, fontWeight: '800', marginTop: 2, textTransform: 'uppercase' },
  ...
  kindGlyph: { color: colors.primaryInk, fontSize: 9, fontWeight: '900' },
  ...
  markAll: { color: colors.primary, fontSize: 11, fontWeight: '900', paddingVertical: spacing.sm },
