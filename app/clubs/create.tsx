...
const styles = StyleSheet.create({
  ...
  step: { color: colors.textSubtle, fontSize: 11, fontWeight: '800', letterSpacing: 0.7, textTransform: 'uppercase' },
  ...
  topicLabel: { color: colors.textMuted, fontSize: 11, fontWeight: '800' },
  ...
  note: { color: colors.textSubtle, fontSize: 11, marginTop: spacing.md, textAlign: 'center' },
});
