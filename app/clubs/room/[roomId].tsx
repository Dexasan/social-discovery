...
const styles = StyleSheet.create({
  ...
  micButton: { alignItems: 'center', backgroundColor: colors.primarySoft, borderColor: '#F3B5E8', borderRadius: radius.md, borderWidth: 1, marginTop: spacing.sm, padding: spacing.md },
  ...
  handButtonRaised: { backgroundColor: colors.primarySoft, borderColor: '#F3B5E8', borderWidth: 1 },
