...
const styles = StyleSheet.create({
  ...
  heroMark: { alignItems: 'center', backgroundColor: colors.primarySoft, borderColor: '#344A88', borderRadius: radius.lg, borderWidth: 1, height: 72, justifyContent: 'center', marginBottom: spacing.md, marginTop: spacing.xl, width: 72 },
  ...
  actionFlex: { flex: 1 },
  liveButton: { alignItems: 'center', backgroundColor: colors.accentSoft, borderColor: '#592635', borderRadius: radius.md, borderWidth: 1, justifyContent: 'center', minWidth: 104, paddingHorizontal: spacing.md },
  ...
  joinPrompt: { backgroundColor: colors.primarySoft, borderColor: '#344A88', borderRadius: radius.lg, borderWidth: 1, gap: 4, padding: spacing.lg },
