...
const styles = StyleSheet.create({
  ...
  heroMark: { alignItems: 'center', backgroundColor: colors.primarySoft, borderColor: '#F3B5E8', borderRadius: radius.lg, borderWidth: 1, height: 72, justifyContent: 'center', marginBottom: spacing.md, marginTop: spacing.xl, width: 72 },
  ...
  ownerName: { color: colors.primary, fontSize: 13, fontWeight: '800' },
  primaryActions: { flexDirection: 'row', gap: spacing.sm, marginTop: spacing.xl },
  actionFlex: { flex: 1 },
  liveButton: { alignItems: 'center', backgroundColor: colors.accentSoft, borderColor: '#FFC4B9', borderRadius: radius.pill, borderWidth: 1, justifyContent: 'center', minWidth: 104, paddingHorizontal: spacing.md },
  ...
  liveClub: { color: colors.textMuted, fontSize: 11, fontWeight: '800', textTransform: 'uppercase' },
  ...
  counter: { color: colors.textSubtle, fontSize: 10, fontWeight: '700' },
  ...
  joinPrompt: { backgroundColor: colors.primarySoft, borderColor: '#F3B5E8', borderRadius: radius.lg, borderWidth: 1, gap: 4, padding: spacing.lg },
  joinPromptTitle: { color: colors.primary, fontSize: 14, fontWeight: '900' },
  ...
  memberMeta: { color: colors.textSubtle, fontSize: 10, marginTop: 2 },
  manageHint: { color: colors.textSubtle, fontSize: 15, fontWeight: '900' },
  ownerHint: { color: colors.textSubtle, fontSize: 10.5, marginTop: spacing.md, textAlign: 'center' },
});
