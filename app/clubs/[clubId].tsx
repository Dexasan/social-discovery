...
const styles = StyleSheet.create({
  ...
  heroMark: { alignItems: 'center', backgroundColor: colors.signal, borderColor: '#B8E346', borderRadius: radius.lg, borderWidth: 1, height: 72, justifyContent: 'center', marginBottom: spacing.md, marginTop: spacing.xl, transform: [{ rotate: '-4deg' }], width: 72 },
  ...
  joinPrompt: { backgroundColor: colors.cobaltSoft, borderColor: '#BFC9FF', borderRadius: radius.lg, borderWidth: 1, gap: 4, padding: spacing.lg },
