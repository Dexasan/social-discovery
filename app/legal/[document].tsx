...
const styles = StyleSheet.create({
  ...
  updated: { color: colors.textSubtle, fontSize: 10, fontWeight: '800', marginTop: spacing.xs, textTransform: 'uppercase' },
  ...
  sectionNumberText: { color: colors.primary, fontSize: 11, fontWeight: '900' },
  ...
  footer: { color: colors.textSubtle, fontSize: 10.5, lineHeight: 16, marginTop: spacing.xl, textAlign: 'center' },
});
