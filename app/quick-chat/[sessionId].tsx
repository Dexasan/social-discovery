...
const styles = StyleSheet.create({
  ...
  keepRow: { alignItems: 'center', backgroundColor: colors.primarySoft, borderBottomColor: '#2D4074', borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: spacing.lg, paddingVertical: spacing.sm },
