...
const styles = StyleSheet.create({
  ...
  container: { flex: 1 },
  header: { alignItems: 'center', borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: 'row', gap: spacing.sm, paddingHorizontal: spacing.md, paddingVertical: spacing.md },
  ...
  partnerName: { color: colors.text, fontSize: 15, fontWeight: '800' },
  textAction: { paddingHorizontal: 5, paddingVertical: spacing.sm },
  textActionLabel: { color: colors.warning, fontSize: 11, fontWeight: '800' },
  blockLabel: { color: colors.danger, fontSize: 11, fontWeight: '800' },
  keepRow: { alignItems: 'center', backgroundColor: colors.surface, borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: spacing.lg, paddingVertical: spacing.sm },
  ...
  keepButtonDone: { backgroundColor: colors.surfaceRaised },
  keepButtonText: { color: colors.primaryInk, fontSize: 11, fontWeight: '800' },
  ...
  theirBubble: { alignSelf: 'flex-start', backgroundColor: colors.surfaceRaised },
  ...
  composer: { alignItems: 'flex-end', borderTopColor: colors.border, borderTopWidth: 1, flexDirection: 'row', gap: spacing.sm, padding: spacing.md },
  input: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: 20, borderWidth: 1, color: colors.text, flex: 1, fontSize: 15, maxHeight: 120, minHeight: 46, paddingHorizontal: spacing.lg, paddingVertical: 12 },
