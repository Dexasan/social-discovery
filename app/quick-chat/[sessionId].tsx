...
const styles = StyleSheet.create({
  ...
  keepRow: { alignItems: 'center', backgroundColor: colors.signalSoft, borderBottomColor: '#CDE987', borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: spacing.lg, paddingVertical: spacing.sm },
  ...
  giftButton: { alignItems: 'center', backgroundColor: colors.warningSoft, borderColor: '#E8C778', borderRadius: 27, borderWidth: 1, height: 54, justifyContent: 'center', width: 54 },
