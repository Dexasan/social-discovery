...
const styles = StyleSheet.create({
  ...
  keepRow: { alignItems: 'center', backgroundColor: colors.primarySoft, borderBottomColor: '#F3B5E8', borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: spacing.lg, paddingVertical: spacing.sm },
