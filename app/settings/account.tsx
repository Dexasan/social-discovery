...
const styles = StyleSheet.create({
  ...
  dangerCard: { backgroundColor: colors.dangerSoft, borderColor: '#FFB9A7', gap: spacing.md },
  dangerHeadingRow: { alignItems: 'flex-start', flexDirection: 'row', gap: spacing.md },
  dangerIcon: { alignItems: 'center', backgroundColor: '#FFC5B8', borderRadius: radius.md, height: 44, justifyContent: 'center', width: 44 },
