...
const styles = StyleSheet.create({
  ...
  dangerCard: { backgroundColor: colors.dangerSoft, borderColor: '#F2B8C5', gap: spacing.md },
  dangerHeadingRow: { alignItems: 'flex-start', flexDirection: 'row', gap: spacing.md },
  dangerIcon: { alignItems: 'center', backgroundColor: '#FFD0DA', borderRadius: radius.md, height: 44, justifyContent: 'center', width: 44 },
