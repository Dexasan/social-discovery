...
const styles = StyleSheet.create({
  ...
  followingAction: { backgroundColor: colors.successSoft, borderColor: '#B9E2D4', borderWidth: 1 },
  ...
  giftEntry: { alignItems: 'center', backgroundColor: colors.warningSoft, borderColor: '#E8C778', borderRadius: radius.lg, borderWidth: 1, flexDirection: 'row', gap: spacing.md, marginTop: spacing.md, padding: spacing.md },
  ...
  openPost: { color: colors.primary, fontSize: 14, fontWeight: '800' },
