...
const aliases = { '/auth':'auth', '/wallet':'wallet', '/messages/new':'messages', '/settings/account':'settings', '/settings/safety':'safety', '/clubs/create':'club-create', '/profile/edit':'profile-edit', '/clubs/[clubId]':'club', '/clubs/room/[roomId]':'room', '/people/[userId]':'person', '/post/[postId]':'post' };
...
export function useLocalSearchParams() { return { conversationId:'review-chat', partnerId:'review-other', partnerName:'Jules', topic:'Music', sessionId:'review-match', userId:'review-other', callId:'review-call', clubId:'1', roomId:'room', postId:'1', body:'Unpopular opinion: the walk home after a concert is part of the concert.', author:'Jules', authorId:'review-other' }; }
